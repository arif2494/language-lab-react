const data = [
	{
		...
		seat: 17,
		level: 'Begainer',
		img: 'https://source.unsplash.com/8MMtYM_3xMY/300x300'
	},
	{
		id: 2,
		...
		seat: 13,
		level: 'Intermadiate',
		img: 'https://source.unsplash.com/2enBTsIVhUU/300x300'
	},
	{
		id: 3,
		...
		seat: 7,
		level: 'Begainer',
		img: 'https://source.unsplash.com/wdPP498hHQ4/300x300'
	},
	{
		id: 4,
		name: 'Bangla Language',
		description:
			'Bengali also known by its endonym Bangla (বাংলা, Bengali pronunciation: [ˈbaŋla]), is an Indo-Aryan language and is the lingua franca of the Bengal region of the Indian subcontinent. It is the official and most widely spoken language of Bangladesh and the second most widely spoken of the 22 scheduled languages of India, after Hindi.',
		price: 19,
		seat: 15,
		level: 'Intermadiate',
		img: 'https://source.unsplash.com/Caahugp6eZ8/300x300'
	},
	{
		id: 5,
		name: 'German Language',
		description:
			'German might not be as familiar to English speakers as Spanish, but its still one of the easiest languages to learn. Like Spanish, its also a phonetic language, which makes pronunciation easy to figure out. ... All of these things can make learning German easier in the beginning.',
		price: 49,
		seat: 12,
		level: 'Beginning',
		img: 'https://source.unsplash.com/cUF4SSxY_KA/300x300'
	},
	{
		id: 6,
		name: 'Hindi Language',
		...
		seat: 52,
		level: 'Intermadiate',
		img: 'https://source.unsplash.com/eU4pipU_8HA/300x300'
	},
	{
		id: 7,
		...
		seat: 32,
		level: 'Beginning',
		img: 'https://source.unsplash.com/LH_Q8DBkgZ0/300x300'
	},
	{
		id: 8,
		name: 'Japanese Language',
		description:
			'Now here is the thing. Japanese is considered one of the most difficult languages to learn. It has a different writing system than English, a completely different grammar structure, and relies heavily on cultural context and understanding.',
		price: 89,
		seat: 15,
		level: 'Intermadiate',
		img: 'https://source.unsplash.com/Bxzrd0p6yOM/300x300'
	}
];
